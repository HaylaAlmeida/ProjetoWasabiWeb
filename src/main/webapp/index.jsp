...
<main>
    <div class="presentation">
        <img src="img/capa.png" class="imagem">
        <div class="about">
            <h2> Restaurante Wasabi </h2>
            <p>Restaurante de COMIDA JAPONESA, de boa qualidade, preços acessíveis e o melhor: com DELIVERY! Registre-se e peça já.</p>
        </div>
